...
object Typo {
    ...
    fun wrongKey(query: String): String {
        var typo: String
        val r = Random()
    ...
    fun missedChar(query: String): String {
        val r = Random()
        val typo: String
    ...
    fun transposedChar(query: String): String {
        val typo: String
        val r = Random()
    ...
    fun doubleChar(query: String): String {
        val r = Random()
        val typo: String
